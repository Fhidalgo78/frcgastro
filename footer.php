        ...
        <div class="row">
            <div class="col-md-12 col-lg-6 d-flex justify-content-center align-items-center mb-sm-3 mb-md-3 mb-lg-0">
                ...
                <div class="info d-flex flex-column">
                    ...
                    <a href="tel:<?php echo $footer['phone_link'] ?>"><i class="fas fa-phone"></i>
                        <?php echo $footer['phone'] ?>
                    </a>
                    <a href="mailto:<?php echo $footer['email'] ?>"><i class="fas fa-envelope"></i>
            ...
            <div class="col-md-12 col-lg-6 d-flex flex-column ">
                <div class="justify-content-end d-flex mb-5">
                    <a class="mx-2" href="https://www.facebook.com/frcgastro/">
                        <img class="socials"
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/2x/face.png" alt="">
                    </a>
                    <a class="mx-2" href="https://www.instagram.com/frcgastro/">
                        <img class="socials"
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/2x/ig.png" alt="">
                    </a>
                </div>
